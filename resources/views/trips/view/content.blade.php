<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title">Comanda Transport</h6>
    ...
    <div class="panel-body no-padding-bottom">
        <div class="row">
            ...
            <div class="col-sm-6 content-group">
                <div class="invoice-details">
                    <h5 class="text-uppercase text-semibold">Comanda #{{ $trip->id }}</h5>
                    <ul class="list-condensed list-unstyled">
                        <li>Data: <span class="text-semibold">{{ format($trip->agreement_date,'d/m/Y') }}</span></li>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-9 content-group">
                <span class="text-muted">Trasportator:</span>
                <ul class="list-condensed list-unstyled">
                    <li><h5>{{ $trip->transporter->name }}</h5></li>
                    {{--<li><span class="text-semibold">Normand axis LTD</span></li>--}}
                    <li>Cod Fiscal: <span class="text-semibold">{{ $trip->transporter->cif }}</span></li>
                    <li>Registrul Comertului: <span class="text-semibold">{{ $trip->transporter->reg_id }}</span></li>
                    <li>Adresa: <span class="text-semibold">{{ $trip->transporter->address }}</span></li>
            ...
            <div class="col-col-md-6 col-lg-3 content-group text-right">
                <span class="text-muted">Beneficiar:</span>
                <ul class="list-condensed list-unstyled">
                    <li><h5>{{ $trip->beneficiary->name }}</h5></li>
                    {{--<li><span class="text-semibold">Normand axis LTD</span></li>--}}
                    <li>Cod Fiscal: <span class="text-semibold">{{ $trip->beneficiary->cif }}</span></li>
                    <li>Registrul Comertului: <span class="text-semibold">{{ $trip->beneficiary->reg_id }}</span></li>
                    <li>Adresa: <span class="text-semibold">{{ $trip->beneficiary->address }}</span></li>
                    {{--<li>3 Goodman Street</li>--}}
                    {{--<li>London E1 8BF</li>--}}
                    {{--<li>United Kingdom</li>--}}
                    {{--<li>888-555-2311</li>--}}
